                        ...
                        <div class="cartItems">
                            ...
                            @foreach($cart_items as $cart_item)
                                <div id="{{ $cart_item->id }}" class="itemCell">
                                    <img class="itemImg" src="{{ secure_asset('uploads/'.json_decode($cart_item->getWishRelation->image)[0]) }}" onclick="window.location='{{ url('/wish/'.$cart_item->getWishRelation->id) }}'">
                                    <div class="itemInfo">
