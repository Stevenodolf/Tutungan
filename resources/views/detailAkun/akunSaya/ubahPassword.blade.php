...
@section('mainContent')
    ...
    <div class="content" id="content4">
        ...
        <form class="changePassword" method="post" action="{{secure_url('/akunSaya/ubahpass')}}">
            {{ csrf_field() }}
            <div class="section">
                <div class="sectionInput">
                    ...
                    <div>
                        ...
                        <a class="contentSemiNormal" style="color: #D5B81B;" href="{{secure_url('/forgotPassword')}}">Lupa Password?</a>
                    </div>
                </div>
                <div class="sectionInput">
