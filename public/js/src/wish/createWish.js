$(document).ready(function () {
    ...
    const pond = FilePond.create(inputElement,{
        ...
        labelMaxFileSize: 'Ukuran per gambar maks. {filesize}',
        labelMaxFileSizeExceeded: 'Gambar terlalu besar',
        labelMaxTotalFileSize: 'Ukuran total gambar maks. {filesize}',
        labelMaxTotalFileSizeExceeded: 'Total ukuran gambar terlalu besar',
